    ...
    <div class="row">
        <div class="col-md-12 col-lg-12 col-xl-12">
            <div class="card card-body pd-40">
                ...
                <form method="POST" action="{{url('airlines/update/'.\Crypt::encrypt($edit_airline->id_airlines))}}" enctype="multipart/form-data">
                    @if (count($errors) > 0)
                        <div class="p-1">
                    ...
                    <div class="row">
                        <div class="col-md-8">
                            <div class="form-group">
                                ...
                                <input type="text" value="{{$edit_airline->Airline}}" name="airline_name" class="form-control" required />
                            </div>
                        </div>
                        <div class="col-md-4">
                            <div class="form-group">
                                <label class="az-content-label tx-11 tx-medium tx-gray-600">Short Code</label>
                                <input type="text" value="{{$edit_airline->ICAO}}" name="airline_short_code" class="form-control" required />
                            </div>
                        </div>
                    </div>
                    <!-- form-group -->
                    ...
                    ?>
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-control select2" name="airline_country">
                                ...
                                <option <?= $my_country->name == $edit_airline->Country ? "selected" : ""?> value="<?=$my_country->name?>"><?=$my_country->name?></option>
                                @endforeach
                                @endif
                            </select>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div>
                                <div class="col-md-12  mb-4">
                                    <img src="<?=$image?>" style="border-radius: 50%;height:100px;width:100px;" alt="" srcset="">
                                </div>
                            </div>
                    ...
                    <div class="form-group">
                        ...
                        <select class="form-control select2" name="airline_status">
                            <option <?= $edit_airline->airline_status == 1 ? "selected" : "" ?> value="1">Active</option>
                            <option <?= $edit_airline->airline_status == 0 ? "selected" : "" ?> value="0">Deactive</option>
