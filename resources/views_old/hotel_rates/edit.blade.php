...
@section('content')
    ...
    <h2 class="az-content-title" style="display: inline">Edit New Hotel Room Rates <span><a
                href="{{ url('hotels/hotel_rates/' . \Crypt::encrypt($room_rates->hotel_id)) }}" class="btn btn-az-primary"
    ...
    <div class="row">
        <div class="col-md-12 col-lg-12 col-xl-12">
            <div class="card card-body pd-40">
                <h5 class="card-title mg-b-20">Edit Hotel Room Rates</h5>
                <form method="post" action="{{ url('hotel_rates/update/' . \Crypt::encrypt($room_rates->id_hotel_rates)) }}">
                    @csrf
                    @if (count($errors) > 0)
                        <div class="p-1">
                    ...
                    <div class="row">
                            ...
                            <div class="row row-sm mg-b-20">
                                <div class="col-md-12">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="from_date" value="{{ date('m-d-Y', strtotime($room_rates->from_date)) }}"
                                            class="form-control"  placeholder="MM/DD/YYYY" class="form-control fc-datepicker" required />
                                    </div>
                                </div>
                            ...
                            <div class="row row-sm mg-b-20">
                                <div class="col-md-12">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="to_date" value="{{ $room_rates->to_date }}"
                                            class="form-control"  placeholder="MM/DD/YYYY" class="form-control fc-datepicker" required />
                                    </div>
                                </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select name="room_type" id="" class="form-control" required>
                                            ...
                                            @foreach ($room_types as $room)
                                                <option @if ($room_rates->room_type_id == $room->id_room_types) selected @endif
                                                    value="{{ $room->id_room_types }}">{{ $room->name }}</option>
                                            @endforeach
                                        </select>
                                    </div>
                                </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select name="vendor" id="" class="form-control" required>
                                            ...
                                            @foreach ($service_vendors as $service_vendor)
                                                <option value="{{ $service_vendor->id_service_vendors }}"
                                                    @if ($service_vendor->id_service_vendors == $room_rates->vendor_id) selected @endif>
                                                    {{ $service_vendor->vendor_name }}</option>
                                            @endforeach
                                        </select>
                                    </div>
                                </div>
                        ...
                        <input type="hidden" name="h_id" value="{{ \Crypt::encrypt($room_rates->hotel_id) }}">
                        <div class="col-md-6">
                            <div class="form-group">
