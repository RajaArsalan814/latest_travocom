...
@section('content')
    ...
    <h2 class="az-content-title" style="display: inline">Add New Room Types <span><a
                href="{{ url('room_types') }}" class="btn btn-az-primary" style="float: right">Room Types
                List</a></span></h2>
                            ...
                            <div class="row row-sm mg-b-20">
                                <div class="col-md-12">
                                    <div class="form-group">
                                        ...
                                        <input type="number" min="1" name="no_of_beds" class="form-control" required />
                                    </div>
                                </div>
