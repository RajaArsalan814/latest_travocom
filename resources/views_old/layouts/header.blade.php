<div class="az-header" style="border-bottom:1px solid #00beda;">
    <div class="container-fluid">
        <div class="az-header-left">
            <a href="index.html" class="az-logo"><span></span> <img src="{{ asset('img/logo.png') }}"
        ...
        <div class="az-header-right">
            @if (checkPermission('inquiry/create') == 1)
                <a href="{{ url('inquiry/create') }}"
                    ...
                    class="az-header-search-link"><i style="color:green;" class="fas fa-plus-square"></i> CREATE
                    INQUIRY</a>
            @endif
            ...
            <div class="az-header-notification">
                <a href="{{ url('/clear-cache') }}" title="Clear System Cache" class="" id="noti_my_jobs"><i
                        class="typcn typcn-refresh" style="font-size:26px;color:#00beda"></i></a>
