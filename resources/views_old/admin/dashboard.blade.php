...
@section('content')
    <div class="az-content-body">
        <div class="az-content-body-left">
            <h2 class="az-content-title tx-24 mg-b-5">Hi, welcome back! <span>{{ auth()->user()->name }}</span></h2>
            ...
            <div class="row row-sm mg-b-20">
                ...
                <div class="col-sm-6 col-lg-4 mg-t-20 mg-sm-t-0">
                    <div class="card card-dashboard-twentysix card-dark-one">
                        <div class="card-header">
                            <h6 class="card-title">Total Inquiry</h6>
                        </div><!-- card-header -->
                        <div class="card-body">
                            <div class="pd-x-15">
                                <h6>{{ $inq_count }} <span> </span></h6>
                                <label></label>
                            </div>
                            <div class="chart-wrapper">
                                <div id="flotChart8" class="flot-chart"></div>
                ...
                <div class="col-lg-4 mg-t-20 mg-lg-t-0">
                    <div class="card card-dashboard-twentysix card-dark-two">
                        ...
                        <div class="card-body">
                            <div class="pd-x-15">
                                <h6>{{ $department_count }}<span></span></h6>
                                <label></label>
                            </div>
                            <div class="chart-wrapper">
            ...
            <div class="col-md-6 offset-3">
                <div id="vmap" class="vmap-wrapper"
                    style="position: relative; overflow: hidden; background-color: rgb(248, 249, 250);"><svg width="608.263"
                        height="365">
                        <g transform="scale(0.6402768421052631) translate(0, 10.03295449501287)">
                            <path
                                ...
                                stroke-opacity="0.3" fill="#ced4da" original="#ced4da" id="jqvmap1_id"
                            ...
                            <path
                                ...
                                stroke="#fff" stroke-width="3" stroke-linecap="round" stroke-linejoin="round"
                                stroke-opacity="0.3" fill="#ced4da" original="#ced4da" id="jqvmap1_pg"
                                class="jqvmap-region"></path>
                            <path
                                ...
                                stroke="#fff" stroke-width="3" stroke-linecap="round" stroke-linejoin="round"
                                stroke-opacity="0.3" fill="#ced4da" original="#ced4da" id="jqvmap1_mx"
                                class="jqvmap-region"></path>
                            <path
                                ...
                                stroke="#fff" stroke-width="3" stroke-linecap="round" stroke-linejoin="round"
                                stroke-opacity="0.3" fill="#ced4da" original="#ced4da" id="jqvmap1_ee"
                                class="jqvmap-region"></path>
                            <path
                                ...
                                stroke="#fff" stroke-width="3" stroke-linecap="round" stroke-linejoin="round"
                                stroke-opacity="0.3" fill="#ced4da" original="#ced4da" id="jqvmap1_dz"
                                class="jqvmap-region"></path>
                            <path
                                ...
                                stroke="#fff" stroke-width="3" stroke-linecap="round" stroke-linejoin="round"
                                stroke-opacity="0.3" fill="#ced4da" original="#ced4da" id="jqvmap1_ma"
                                class="jqvmap-region"></path>
                            <path
                                ...
                                stroke="#fff" stroke-width="3" stroke-linecap="round" stroke-linejoin="round"
                                stroke-opacity="0.3" fill="#ced4da" original="#ced4da" id="jqvmap1_mr"
                                class="jqvmap-region"></path>
                            <path
                            ...
                            <path
                                ...
                                stroke="#fff" stroke-width="3" stroke-linecap="round" stroke-linejoin="round"
                                stroke-opacity="0.3" fill="#ced4da" original="#ced4da" id="jqvmap1_ci"
                                class="jqvmap-region"></path>
                            <path
                                ...
                                stroke="#fff" stroke-width="3" stroke-linecap="round" stroke-linejoin="round"
                                stroke-opacity="0.3" fill="#ced4da" original="#ced4da" id="jqvmap1_ml"
                                class="jqvmap-region"></path>
                            <path
                                ...
                                stroke="#fff" stroke-width="3" stroke-linecap="round" stroke-linejoin="round"
                                stroke-opacity="0.3" fill="#ced4da" original="#ced4da" id="jqvmap1_bf"
                                class="jqvmap-region"></path>
                            <path
                            ...
                            <path
                                ...
                                stroke="#fff" stroke-width="3" stroke-linecap="round" stroke-linejoin="round"
                                stroke-opacity="0.3" fill="#ced4da" original="#ced4da" id="jqvmap1_ng"
                                class="jqvmap-region"></path>
                            <path
                                ...
                                stroke="#fff" stroke-width="3" stroke-linecap="round" stroke-linejoin="round"
                                stroke-opacity="0.3" fill="#ced4da" original="#ced4da" id="jqvmap1_tn"
                                class="jqvmap-region"></path>
                            <path
                                ...
                                stroke="#fff" stroke-width="3" stroke-linecap="round" stroke-linejoin="round"
                                stroke-opacity="0.3" fill="#ced4da" original="#ced4da" id="jqvmap1_ly"
                                class="jqvmap-region"></path>
                            <path
                                ...
                                stroke="#fff" stroke-width="3" stroke-linecap="round" stroke-linejoin="round"
                                stroke-opacity="0.3" fill="#ced4da" original="#ced4da" id="jqvmap1_eg"
                                class="jqvmap-region"></path>
                            <path
                                ...
                                stroke="#fff" stroke-width="3" stroke-linecap="round" stroke-linejoin="round"
                                stroke-opacity="0.3" fill="#ced4da" original="#ced4da" id="jqvmap1_td"
                                class="jqvmap-region"></path>
                            <path
                                ...
                                stroke="#fff" stroke-width="3" stroke-linecap="round" stroke-linejoin="round"
                                stroke-opacity="0.3" fill="#ced4da" original="#ced4da" id="jqvmap1_sd"
                                class="jqvmap-region"></path>
                            <path
                            ...
                            <path
                                ...
                                stroke="#fff" stroke-width="3" stroke-linecap="round" stroke-linejoin="round"
                                stroke-opacity="0.3" fill="#ced4da" original="#ced4da" id="jqvmap1_et"
                                class="jqvmap-region"></path>
                            <path
                                ...
                                stroke="#fff" stroke-width="3" stroke-linecap="round" stroke-linejoin="round"
                                stroke-opacity="0.3" fill="#ced4da" original="#ced4da" id="jqvmap1_so"
                                class="jqvmap-region"></path>
                            <path
                                ...
                                stroke="#fff" stroke-width="3" stroke-linecap="round" stroke-linejoin="round"
                                stroke-opacity="0.3" fill="#ced4da" original="#ced4da" id="jqvmap1_ye"
                                class="jqvmap-region"></path>
                            <path
                                ...
                                stroke="#fff" stroke-width="3" stroke-linecap="round" stroke-linejoin="round"
                                stroke-opacity="0.3" fill="#ced4da" original="#ced4da" id="jqvmap1_cf"
                                class="jqvmap-region"></path>
                            <path
                                ...
                                stroke="#fff" stroke-width="3" stroke-linecap="round" stroke-linejoin="round"
                                stroke-opacity="0.3" fill="#ced4da" original="#ced4da" id="jqvmap1_st"
                                class="jqvmap-region"></path>
                            <path
                                ...
                                stroke="#fff" stroke-width="3" stroke-linecap="round" stroke-linejoin="round"
                                stroke-opacity="0.3" fill="#ced4da" original="#ced4da" id="jqvmap1_gq"
                                class="jqvmap-region"></path>
                            <path
                                ...
                                stroke="#fff" stroke-width="3" stroke-linecap="round" stroke-linejoin="round"
                                stroke-opacity="0.3" fill="#ced4da" original="#ced4da" id="jqvmap1_ga"
                                class="jqvmap-region"></path>
                            <path
                                ...
                                stroke="#fff" stroke-width="3" stroke-linecap="round" stroke-linejoin="round"
                                stroke-opacity="0.3" fill="#ced4da" original="#ced4da" id="jqvmap1_cg"
                                class="jqvmap-region"></path>
                            <path
                                ...
                                stroke="#fff" stroke-width="3" stroke-linecap="round" stroke-linejoin="round"
                                stroke-opacity="0.3" fill="#ced4da" original="#ced4da" id="jqvmap1_ao"
                                class="jqvmap-region"></path>
                            <path
                                ...
                                stroke="#fff" stroke-width="3" stroke-linecap="round" stroke-linejoin="round"
                                stroke-opacity="0.3" fill="#ced4da" original="#ced4da" id="jqvmap1_cd"
                                class="jqvmap-region"></path>
                            <path d="M537.82,339.9l2.81,2.59l-0.12,2.77l-4.36,0.09v-3.06L537.82,339.9L537.82,339.9z"
                                stroke="#fff" stroke-width="3" stroke-linecap="round" stroke-linejoin="round"
                                stroke-opacity="0.3" fill="#ced4da" original="#ced4da" id="jqvmap1_rw"
                                class="jqvmap-region"></path>
                            <path
                                d="M536.21,346.21l4.27-0.09l-1.11,3.74l-1.08,0.94h-1.32l-0.94-2.53L536.21,346.21L536.21,346.21z"
                                stroke="#fff" stroke-width="3" stroke-linecap="round" stroke-linejoin="round"
                                stroke-opacity="0.3" fill="#ced4da" original="#ced4da" id="jqvmap1_bi"
                                class="jqvmap-region"></path>
                            <path
                                ...
                                stroke="#fff" stroke-width="3" stroke-linecap="round" stroke-linejoin="round"
                                stroke-opacity="0.3" fill="#ced4da" original="#ced4da" id="jqvmap1_ug"
                                class="jqvmap-region"></path>
                            <path
                                ...
                                stroke="#fff" stroke-width="3" stroke-linecap="round" stroke-linejoin="round"
                                stroke-opacity="0.3" fill="#ced4da" original="#ced4da" id="jqvmap1_ke"
                                class="jqvmap-region"></path>
                            <path
                                ...
                                stroke="#fff" stroke-width="3" stroke-linecap="round" stroke-linejoin="round"
                                stroke-opacity="0.3" fill="#ced4da" original="#ced4da" id="jqvmap1_tz"
                                class="jqvmap-region"></path>
                            <path
                                ...
                                stroke="#fff" stroke-width="3" stroke-linecap="round" stroke-linejoin="round"
                                stroke-opacity="0.3" fill="#ced4da" original="#ced4da" id="jqvmap1_zm"
                                class="jqvmap-region"></path>
                            <path
                                ...
                                stroke="#fff" stroke-width="3" stroke-linecap="round" stroke-linejoin="round"
                                stroke-opacity="0.3" fill="#ced4da" original="#ced4da" id="jqvmap1_mw"
                                class="jqvmap-region"></path>
                            <path
                                ...
                                stroke="#fff" stroke-width="3" stroke-linecap="round" stroke-linejoin="round"
                                stroke-opacity="0.3" fill="#ced4da" original="#ced4da" id="jqvmap1_mz"
                            ...
                            <path
                                ...
                                stroke="#fff" stroke-width="3" stroke-linecap="round" stroke-linejoin="round"
                                stroke-opacity="0.3" fill="#ced4da" original="#ced4da" id="jqvmap1_zw"
                                class="jqvmap-region"></path>
                            <path
                                ...
                                stroke="#fff" stroke-width="3" stroke-linecap="round" stroke-linejoin="round"
                                stroke-opacity="0.3" fill="#ced4da" original="#ced4da" id="jqvmap1_na"
                                class="jqvmap-region"></path>
                            <path
                                ...
                                stroke="#fff" stroke-width="3" stroke-linecap="round" stroke-linejoin="round"
                                stroke-opacity="0.3" fill="#ced4da" original="#ced4da" id="jqvmap1_bw"
                                class="jqvmap-region"></path>
                            <path d="M540.87,414l-2.51,0.42l-1.08,2.95l1.92,1.75h2.33l1.97-2.83L540.87,414L540.87,414z"
                                stroke="#fff" stroke-width="3" stroke-linecap="round" stroke-linejoin="round"
                                stroke-opacity="0.3" fill="#ced4da" original="#ced4da" id="jqvmap1_sz"
                                class="jqvmap-region"></path>
                            <path
                                ...
                                stroke="#fff" stroke-width="3" stroke-linecap="round" stroke-linejoin="round"
                                stroke-opacity="0.3" fill="#ced4da" original="#ced4da" id="jqvmap1_ls"
                                class="jqvmap-region"></path>
                            <path
                                d="M534.16,403.63l-7.9,7.3l-1.88,4.51l-6.26-0.78l-5.21,4.63l-3.46-0.34l0.28-6.4l-1.23-0.43l-0.86,13.09l-6.14-0.06l-1.85-2.18l-2.71-0.03l2.47,7.09l4.41,4.17l-3.15,3.67l2.04,4.6l4.72,1.8l3.76-3.2l10.77,0.06l0.77-0.96l4.78-0.84l16.17-16.1l-0.06-5.07l-1.73,2.24h-2.59l-3.15-2.64l1.6-3.98l2.75-0.56l-0.25-8.18L534.16,403.63L534.16,403.63z M530.37,422.13l1.51-0.06l2.45,2.66l-0.07,3.08l-2.87,1.45l-0.18,1.02l-4.38,0.05l-1.37-3.3l1.25-2.42L530.37,422.13L530.37,422.13z"
                                stroke="#fff" stroke-width="3" stroke-linecap="round" stroke-linejoin="round"
                                stroke-opacity="0.3" fill="#ced4da" original="#ced4da" id="jqvmap1_za"
                                class="jqvmap-region" fill-opacity="1"></path>
                            <path
                                ...
                                stroke="#fff" stroke-width="3" stroke-linecap="round" stroke-linejoin="round"
                                stroke-opacity="0.3" fill="#ced4da" original="#ced4da" id="jqvmap1_gl"
                                class="jqvmap-region"></path>
                            <path
                                ...
                                stroke="#fff" stroke-width="3" stroke-linecap="round" stroke-linejoin="round"
                                stroke-opacity="0.3" fill="#dfd3f2" original="#dfd3f2" id="jqvmap1_au"
                                class="jqvmap-region"></path>
                            <path
                            ...
                            <path
                                ...
                                stroke="#fff" stroke-width="3" stroke-linecap="round" stroke-linejoin="round"
                                stroke-opacity="0.3" fill="#ced4da" original="#ced4da" id="jqvmap1_sb"
                                class="jqvmap-region"></path>
                            <path
                                ...
                                stroke="#fff" stroke-width="3" stroke-linecap="round" stroke-linejoin="round"
                                stroke-opacity="0.3" fill="#ced4da" original="#ced4da" id="jqvmap1_vu"
                                class="jqvmap-region"></path>
                            <path d="M948.62,412.29l-1.24,1.66l-0.1,1.87l1.44,1.46L948.62,412.29L948.62,412.29z"
                                stroke="#fff" stroke-width="3" stroke-linecap="round" stroke-linejoin="round"
                                stroke-opacity="0.3" fill="#ced4da" original="#ced4da" id="jqvmap1_fj"
                                class="jqvmap-region"></path>
                            <path
                                ...
                                stroke="#fff" stroke-width="3" stroke-linecap="round" stroke-linejoin="round"
                                stroke-opacity="0.3" fill="#ced4da" original="#ced4da" id="jqvmap1_ph"
                                class="jqvmap-region"></path>
                            <path
                                ...
                                stroke="#fff" stroke-width="3" stroke-linecap="round" stroke-linejoin="round"
                                stroke-opacity="0.3" fill="#c8aef4" original="#c8aef4" id="jqvmap1_cn"
                                class="jqvmap-region"></path>
                            <path d="M787.46,248.31l-3.54,2.7l-0.19,5.2l3.06,3.56l0.76-0.67L787.46,248.31L787.46,248.31z"
                                stroke="#fff" stroke-width="3" stroke-linecap="round" stroke-linejoin="round"
                                stroke-opacity="0.3" fill="#ced4da" original="#ced4da" id="jqvmap1_tw"
                                class="jqvmap-region"></path>
                            <path
                                ...
                                stroke="#fff" stroke-width="3" stroke-linecap="round" stroke-linejoin="round"
                                stroke-opacity="0.3" fill="#ced4da" original="#ced4da" id="jqvmap1_jp"
                                class="jqvmap-region"></path>
                            <path
                                ...
                                stroke="#fff" stroke-width="3" stroke-linecap="round" stroke-linejoin="round"
                                stroke-opacity="0.3" fill="#aa7df3" original="#aa7df3" id="jqvmap1_ru"
                                class="jqvmap-region" fill-opacity="1"></path>
                            <path
                                ...
                                stroke="#fff" stroke-width="3" stroke-linecap="round" stroke-linejoin="round"
                                stroke-opacity="0.3" fill="#6610f2" original="#6610f2" id="jqvmap1_us"
                                class="jqvmap-region"></path>
                            <path d="M613.01,398.99l-1.52,1.99l0.3,2.15l3.2-2.61L613.01,398.99L613.01,398.99z"
                                stroke="#fff" stroke-width="3" stroke-linecap="round" stroke-linejoin="round"
                                stroke-opacity="0.3" fill="#ced4da" original="#ced4da" id="jqvmap1_mu"
                                class="jqvmap-region"></path>
                            <path d="M607.38,402.37l-2.28,0.15l-0.15,1.99l1.52,0.31l2.28-1.07L607.38,402.37L607.38,402.37z"
                                stroke="#fff" stroke-width="3" stroke-linecap="round" stroke-linejoin="round"
                                stroke-opacity="0.3" fill="#ced4da" original="#ced4da" id="jqvmap1_re"
                                class="jqvmap-region"></path>
                            <path
                                ...
                                stroke="#fff" stroke-width="3" stroke-linecap="round" stroke-linejoin="round"
                                stroke-opacity="0.3" fill="#ced4da" original="#ced4da" id="jqvmap1_mg"
                                class="jqvmap-region"></path>
                            <path
                                ...
                                stroke="#fff" stroke-width="3" stroke-linecap="round" stroke-linejoin="round"
                                stroke-opacity="0.3" fill="#ced4da" original="#ced4da" id="jqvmap1_km"
                                class="jqvmap-region"></path>
                            <path
                                ...
                                stroke="#fff" stroke-width="3" stroke-linecap="round" stroke-linejoin="round"
                                stroke-opacity="0.3" fill="#ced4da" original="#ced4da" id="jqvmap1_sc"
                                class="jqvmap-region"></path>
                            <path
                                ...
                                stroke="#fff" stroke-width="3" stroke-linecap="round" stroke-linejoin="round"
                                stroke-opacity="0.3" fill="#ced4da" original="#ced4da" id="jqvmap1_mv"
                                class="jqvmap-region"></path>
                            <path
                                ...
                                stroke="#fff" stroke-width="3" stroke-linecap="round" stroke-linejoin="round"
                                stroke-opacity="0.3" fill="#ced4da" original="#ced4da" id="jqvmap1_pt"
                                class="jqvmap-region"></path>
                            <path
                                d="M415.62,253.73l-1.75,1.01l0.81,0.82L415.62,253.73L415.62,253.73M409.54,253.92l-2.17,0.55l1.08,1.64h1.63L409.54,253.92L409.54,253.92M404.38,252.28l-1.36,1.37l1.9,1.64l1.08-2.46L404.38,252.28L404.38,252.28M448.36,205h-12.74l-2.57-1.16l-1.24,0.09l-1.5,3.12l0.53,3.21l4.87,0.45l0.62,2.05l-2.12,11.95l0.09,2.14l3.45,1.87l3.98,0.27l7.96-1.96l3.89-4.9l0.09-4.99l6.9-6.24l0.35-2.76l-6.28-0.09L448.36,205L448.36,205M461.1,217.21l-1.59,0.54l0.35,1.43h2.3l0.97-1.07L461.1,217.21L461.1,217.21z"
                                stroke="#fff" stroke-width="3" stroke-linecap="round" stroke-linejoin="round"
                                stroke-opacity="0.3" fill="#ced4da" original="#ced4da" id="jqvmap1_es"
                                class="jqvmap-region"></path>
                            <path
                                ...
                                stroke="#fff" stroke-width="3" stroke-linecap="round" stroke-linejoin="round"
                                stroke-opacity="0.3" fill="#ced4da" original="#ced4da" id="jqvmap1_cv"
                                class="jqvmap-region"></path>
                            <path
                            ...
                            <path
                                ...
                                stroke="#fff" stroke-width="3" stroke-linecap="round" stroke-linejoin="round"
                                stroke-opacity="0.3" fill="#ced4da" original="#ced4da" id="jqvmap1_ht"
                                class="jqvmap-region"></path>
                            <path
                                ...
                                stroke="#fff" stroke-width="3" stroke-linecap="round" stroke-linejoin="round"
                                stroke-opacity="0.3" fill="#ced4da" original="#ced4da" id="jqvmap1_fk"
                                class="jqvmap-region"></path>
                            <path
                                ...
                                stroke="#fff" stroke-width="3" stroke-linecap="round" stroke-linejoin="round"
                                stroke-opacity="0.3" fill="#ced4da" original="#ced4da" id="jqvmap1_is"
                                class="jqvmap-region"></path>
                            <path
                                ...
                                stroke="#fff" stroke-width="3" stroke-linecap="round" stroke-linejoin="round"
                                stroke-opacity="0.3" fill="#ced4da" original="#ced4da" id="jqvmap1_no"
                                class="jqvmap-region"></path>
                            <path
                                ...
                                stroke="#fff" stroke-width="3" stroke-linecap="round" stroke-linejoin="round"
                                stroke-opacity="0.3" fill="#ced4da" original="#ced4da" id="jqvmap1_lk"
                                class="jqvmap-region"></path>
                            <path
                                ...
                                stroke="#fff" stroke-width="3" stroke-linecap="round" stroke-linejoin="round"
                                stroke-opacity="0.3" fill="#ced4da" original="#ced4da" id="jqvmap1_cu"
                                class="jqvmap-region"></path>
                            <path
                                ...
                                stroke="#fff" stroke-width="3" stroke-linecap="round" stroke-linejoin="round"
                                stroke-opacity="0.3" fill="#ced4da" original="#ced4da" id="jqvmap1_bs"
                                class="jqvmap-region"></path>
                            <path d="M238.93,279.59l-3.48,0.88v0.97l2.03,1.17h2.13l1.35-1.56L238.93,279.59L238.93,279.59z"
                                stroke="#fff" stroke-width="3" stroke-linecap="round" stroke-linejoin="round"
                                stroke-opacity="0.3" fill="#ced4da" original="#ced4da" id="jqvmap1_jm"
                                class="jqvmap-region"></path>
                            <path
                                ...
                                stroke="#fff" stroke-width="3" stroke-linecap="round" stroke-linejoin="round"
                                stroke-opacity="0.3" fill="#ced4da" original="#ced4da" id="jqvmap1_ec"
                                class="jqvmap-region"></path>
                            <path
                                ...
                                stroke="#fff" stroke-width="3" stroke-linecap="round" stroke-linejoin="round"
                                stroke-opacity="0.3" fill="#ced4da" original="#ced4da" id="jqvmap1_ca"
                                class="jqvmap-region"></path>
                            <path
                                ...
                                stroke="#fff" stroke-width="3" stroke-linecap="round" stroke-linejoin="round"
                                stroke-opacity="0.3" fill="#ced4da" original="#ced4da" id="jqvmap1_gt"
                                class="jqvmap-region"></path>
                            <path
                            ...
                            <path
                                ...
                                stroke="#fff" stroke-width="3" stroke-linecap="round" stroke-linejoin="round"
                                stroke-opacity="0.3" fill="#ced4da" original="#ced4da" id="jqvmap1_pa"
                                class="jqvmap-region"></path>
                            <path
                                ...
                                stroke="#fff" stroke-width="3" stroke-linecap="round" stroke-linejoin="round"
                                stroke-opacity="0.3" fill="#ced4da" original="#ced4da" id="jqvmap1_co"
                                class="jqvmap-region"></path>
                            <path
                                ...
                                stroke="#fff" stroke-width="3" stroke-linecap="round" stroke-linejoin="round"
                                stroke-opacity="0.3" fill="#ced4da" original="#ced4da" id="jqvmap1_ve"
                                class="jqvmap-region"></path>
                            <path
                                ...
                                stroke="#fff" stroke-width="3" stroke-linecap="round" stroke-linejoin="round"
                                stroke-opacity="0.3" fill="#ced4da" original="#ced4da" id="jqvmap1_gy"
                                class="jqvmap-region"></path>
                            <path
                                ...
                                stroke="#fff" stroke-width="3" stroke-linecap="round" stroke-linejoin="round"
                                stroke-opacity="0.3" fill="#ced4da" original="#ced4da" id="jqvmap1_sr"
                                class="jqvmap-region"></path>
                            <path
                                d="M302.13,321.8l5.85,3.65l-3.06,6.08l-1.11,1.4l-3.25-1.87l0.09-6.55L302.13,321.8L302.13,321.8z"
                                stroke="#fff" stroke-width="3" stroke-linecap="round" stroke-linejoin="round"
                                stroke-opacity="0.3" fill="#ced4da" original="#ced4da" id="jqvmap1_gf"
                                class="jqvmap-region"></path>
                            <path
                                ...
                                stroke="#fff" stroke-width="3" stroke-linecap="round" stroke-linejoin="round"
                                stroke-opacity="0.3" fill="#ced4da" original="#ced4da" id="jqvmap1_pe"
                                class="jqvmap-region"></path>
                            <path
                                ...
                                stroke="#fff" stroke-width="3" stroke-linecap="round" stroke-linejoin="round"
                                stroke-opacity="0.3" fill="#ced4da" original="#ced4da" id="jqvmap1_bo"
                                class="jqvmap-region"></path>
                            <path
                                ...
                                stroke="#fff" stroke-width="3" stroke-linecap="round" stroke-linejoin="round"
                                stroke-opacity="0.3" fill="#ced4da" original="#ced4da" id="jqvmap1_py"
                                class="jqvmap-region"></path>
                            <path
                                d="M300.36,431.93l-2.05,2.19l0.85,11.78l6.44,1.87l8.19-8.21L300.36,431.93L300.36,431.93z"
                                stroke="#fff" stroke-width="3" stroke-linecap="round" stroke-linejoin="round"
                                stroke-opacity="0.3" fill="#ced4da" original="#ced4da" id="jqvmap1_uy"
                                class="jqvmap-region"></path>
                            <path
                                ...
                                stroke="#fff" stroke-width="3" stroke-linecap="round" stroke-linejoin="round"
                                stroke-opacity="0.3" fill="#ced4da" original="#ced4da" id="jqvmap1_ar"
                                class="jqvmap-region"></path>
                            <path
                                ...
                                stroke="#fff" stroke-width="3" stroke-linecap="round" stroke-linejoin="round"
                                stroke-opacity="0.3" fill="#ced4da" original="#ced4da" id="jqvmap1_cl"
                                class="jqvmap-region"></path>
                            <path
                                ...
                                stroke="#fff" stroke-width="3" stroke-linecap="round" stroke-linejoin="round"
                                stroke-opacity="0.3" fill="#ced4da" original="#ced4da" id="jqvmap1_br"
                                class="jqvmap-region"></path>
                            <path d="M204.56,282.4l-0.05,3.65h0.84l2.86-5.34h-1.94L204.56,282.4L204.56,282.4z"
                                stroke="#fff" stroke-width="3" stroke-linecap="round" stroke-linejoin="round"
                                stroke-opacity="0.3" fill="#ced4da" original="#ced4da" id="jqvmap1_bz"
                                class="jqvmap-region"></path>
                            <path
                                d="M673.8,170.17l5.82-7.72l6.99,3.23l4.75,1.27l5.82-5.34l-3.95-2.91l2.6-3.67l7.76,2.74l2.69,4.41l4.86,0.13l2.54-1.89l5.23-0.21l1.14,1.94l8.69,0.44l5.5-5.61l7.61,0.8l-0.44,7.64l3.33,0.76l4.09-1.86l4.33,2.14l-0.1,1.08l-3.14,0.09l-3.27,6.86l-2.54,0.25l-9.88,12.91l-10.09,4.45l-6.31,0.49l-5.24-3.38l-6.7,3.58l-6.6-2.05l-1.87-4.79l-12.5-0.88l-6.4-10.85l-3.11-0.2L673.8,170.17L673.8,170.17z"
                                stroke="#fff" stroke-width="3" stroke-linecap="round" stroke-linejoin="round"
                                stroke-opacity="0.3" fill="#ced4da" original="#ced4da" id="jqvmap1_mn"
                                class="jqvmap-region"></path>
                            <path
                                ...
                                stroke="#fff" stroke-width="3" stroke-linecap="round" stroke-linejoin="round"
                                stroke-opacity="0.3" fill="#ced4da" original="#ced4da" id="jqvmap1_kp"
                                class="jqvmap-region"></path>
                            <path
                                ...
                                stroke="#fff" stroke-width="3" stroke-linecap="round" stroke-linejoin="round"
                                stroke-opacity="0.3" fill="#ced4da" original="#ced4da" id="jqvmap1_kr"
                                class="jqvmap-region"></path>
                            <path
                                ...
                                stroke="#fff" stroke-width="3" stroke-linecap="round" stroke-linejoin="round"
                                stroke-opacity="0.3" fill="#ced4da" original="#ced4da" id="jqvmap1_kz"
                                class="jqvmap-region" fill-opacity="1"></path>
                            <path
                                ...
                                stroke="#fff" stroke-width="3" stroke-linecap="round" stroke-linejoin="round"
                                stroke-opacity="0.3" fill="#ced4da" original="#ced4da" id="jqvmap1_tm"
                                class="jqvmap-region" fill-opacity="1"></path>
                            <path
                                ...
                                stroke="#fff" stroke-width="3" stroke-linecap="round" stroke-linejoin="round"
                                stroke-opacity="0.3" fill="#ced4da" original="#ced4da" id="jqvmap1_uz"
                                class="jqvmap-region" fill-opacity="1"></path>
                            <path
                                ...
                                stroke="#fff" stroke-width="3" stroke-linecap="round" stroke-linejoin="round"
                                stroke-opacity="0.3" fill="#ced4da" original="#ced4da" id="jqvmap1_tj"
                                class="jqvmap-region"></path>
                            <path
                                ...
                                stroke="#fff" stroke-width="3" stroke-linecap="round" stroke-linejoin="round"
                                stroke-opacity="0.3" fill="#ced4da" original="#ced4da" id="jqvmap1_kg"
                                class="jqvmap-region"></path>
                            <path
                                ...
                                stroke="#fff" stroke-width="3" stroke-linecap="round" stroke-linejoin="round"
                                stroke-opacity="0.3" fill="#ced4da" original="#ced4da" id="jqvmap1_af"
                                class="jqvmap-region"></path>
                            <path
                                ...
                                stroke="#fff" stroke-width="3" stroke-linecap="round" stroke-linejoin="round"
                                stroke-opacity="0.3" fill="#ced4da" original="#ced4da" id="jqvmap1_pk"
                                class="jqvmap-region"></path>
                            <path
                            ...
                            <path
                                ...
                                stroke="#fff" stroke-width="3" stroke-linecap="round" stroke-linejoin="round"
                                stroke-opacity="0.3" fill="#ced4da" original="#ced4da" id="jqvmap1_bd"
                                class="jqvmap-region"></path>
                            <path
                                d="M729.44,303.65l-2.77-4.44l2.01-2.82l-1.9-3.49l-1.79-0.34l-0.34-5.86l-2.68-5.19l-0.78,1.24l-1.79,3.04l-2.24,0.34l-1.12-1.47l-0.56-3.95l-1.68-3.16l-6.84-6.45l1.68-1.11l0.31-4.67l2.5-4.2l1.08-10.45l3.62-2.47l0.12-3.81l2.17,0.72l3.42,4.95l-2.54,5.44l1.71,4.27l4.23,1.66l0.77,4.65l5.68,0.88l-1.57,2.71l-7.16,2.82l-0.78,4.62l5.26,6.76l0.22,3.61l-1.23,1.24l0.11,1.13l3.92,5.75l0.11,5.97L729.44,303.65L729.44,303.65z"
                                stroke="#fff" stroke-width="3" stroke-linecap="round" stroke-linejoin="round"
                                stroke-opacity="0.3" fill="#ced4da" original="#ced4da" id="jqvmap1_mm"
                                class="jqvmap-region"></path>
                            <path
                                ...
                                stroke="#fff" stroke-width="3" stroke-linecap="round" stroke-linejoin="round"
                                stroke-opacity="0.3" fill="#ced4da" original="#ced4da" id="jqvmap1_th"
                                class="jqvmap-region"></path>
                            <path
                                ...
                                stroke="#fff" stroke-width="3" stroke-linecap="round" stroke-linejoin="round"
                                stroke-opacity="0.3" fill="#ced4da" original="#ced4da" id="jqvmap1_kh"
                                class="jqvmap-region"></path>
                            <path
                                ...
                                stroke="#fff" stroke-width="3" stroke-linecap="round" stroke-linejoin="round"
                                stroke-opacity="0.3" fill="#ced4da" original="#ced4da" id="jqvmap1_la"
                                class="jqvmap-region"></path>
                            <path
                            ...
                            <path
                                ...
                                stroke="#fff" stroke-width="3" stroke-linecap="round" stroke-linejoin="round"
                                stroke-opacity="0.3" fill="#ced4da" original="#ced4da" id="jqvmap1_az"
                                class="jqvmap-region"></path>
                            <path
                                ...
                                stroke="#fff" stroke-width="3" stroke-linecap="round" stroke-linejoin="round"
                                stroke-opacity="0.3" fill="#ced4da" original="#ced4da" id="jqvmap1_ir"
                                class="jqvmap-region" fill-opacity="1"></path>
                            <path
                                ...
                                stroke="#fff" stroke-width="3" stroke-linecap="round" stroke-linejoin="round"
                                stroke-opacity="0.3" fill="#ced4da" original="#ced4da" id="jqvmap1_tr"
                                class="jqvmap-region"></path>
                            <path
                            ...
                            <path
                                ...
                                stroke="#fff" stroke-width="3" stroke-linecap="round" stroke-linejoin="round"
                                stroke-opacity="0.3" fill="#ced4da" original="#ced4da" id="jqvmap1_sa"
                                class="jqvmap-region"></path>
                            <path
                                ...
                                stroke="#fff" stroke-width="3" stroke-linecap="round" stroke-linejoin="round"
                                stroke-opacity="0.3" fill="#ced4da" original="#ced4da" id="jqvmap1_sy"
                                class="jqvmap-region"></path>
                            <path
                                ...
                                stroke="#fff" stroke-width="3" stroke-linecap="round" stroke-linejoin="round"
                                stroke-opacity="0.3" fill="#ced4da" original="#ced4da" id="jqvmap1_iq"
                                class="jqvmap-region"></path>
                            <path
                            ...
                            <path
                                ...
                                stroke="#fff" stroke-width="3" stroke-linecap="round" stroke-linejoin="round"
                                stroke-opacity="0.3" fill="#8b4bf3" original="#8b4bf3" id="jqvmap1_gb"
                                class="jqvmap-region"></path>
                            <path
                                ...
                                stroke="#fff" stroke-width="3" stroke-linecap="round" stroke-linejoin="round"
                                stroke-opacity="0.3" fill="#ced4da" original="#ced4da" id="jqvmap1_ie"
                                class="jqvmap-region"></path>
                            <path
                                ...
                                stroke="#fff" stroke-width="3" stroke-linecap="round" stroke-linejoin="round"
                                stroke-opacity="0.3" fill="#ced4da" original="#ced4da" id="jqvmap1_se"
                                class="jqvmap-region"></path>
                            <path
                                ...
                                stroke="#fff" stroke-width="3" stroke-linecap="round" stroke-linejoin="round"
                                stroke-opacity="0.3" fill="#ced4da" original="#ced4da" id="jqvmap1_fi"
                                class="jqvmap-region"></path>
                            <path
                                d="M518.07,151.37l-6.85-1.11l0.15,3.83l6.35,3.88l2.6-0.76l-0.15-2.92L518.07,151.37L518.07,151.37z"
                                stroke="#fff" stroke-width="3" stroke-linecap="round" stroke-linejoin="round"
                                stroke-opacity="0.3" fill="#ced4da" original="#ced4da" id="jqvmap1_lv"
                                class="jqvmap-region"></path>
                            <path
                                ...
                                stroke="#fff" stroke-width="3" stroke-linecap="round" stroke-linejoin="round"
                                stroke-opacity="0.3" fill="#ced4da" original="#ced4da" id="jqvmap1_lt"
                                class="jqvmap-region"></path>
                            <path
                                ...
                                stroke="#fff" stroke-width="3" stroke-linecap="round" stroke-linejoin="round"
                                stroke-opacity="0.3" fill="#ced4da" original="#ced4da" id="jqvmap1_by"
                                class="jqvmap-region"></path>
                            <path
                                ...
                                stroke="#fff" stroke-width="3" stroke-linecap="round" stroke-linejoin="round"
                                stroke-opacity="0.3" fill="#ced4da" original="#ced4da" id="jqvmap1_pl"
                                class="jqvmap-region"></path>
                            <path
                                ...
                                stroke="#fff" stroke-width="3" stroke-linecap="round" stroke-linejoin="round"
                                stroke-opacity="0.3" fill="#ced4da" original="#ced4da" id="jqvmap1_it"
                                class="jqvmap-region"></path>
                            <path
                                ...
                                stroke="#fff" stroke-width="3" stroke-linecap="round" stroke-linejoin="round"
                                stroke-opacity="0.3" fill="#ced4da" original="#ced4da" id="jqvmap1_fr"
                                class="jqvmap-region"></path>
                            <path
                                ...
                                stroke="#fff" stroke-width="3" stroke-linecap="round" stroke-linejoin="round"
                                stroke-opacity="0.3" fill="#ced4da" original="#ced4da" id="jqvmap1_nl"
                                class="jqvmap-region"></path>
                            <path
                                d="M461.61,176.52l-0.64,1.6l6.88,4.54l1.98,0.47l0.07-2.15l-1.73-1.94h-1.06l-1.45-1.65L461.61,176.52L461.61,176.52z"
                                stroke="#fff" stroke-width="3" stroke-linecap="round" stroke-linejoin="round"
                                stroke-opacity="0.3" fill="#ced4da" original="#ced4da" id="jqvmap1_be"
                                class="jqvmap-region"></path>
                            <path
                                ...
                                stroke="#fff" stroke-width="3" stroke-linecap="round" stroke-linejoin="round"
                                stroke-opacity="0.3" fill="#ced4da" original="#ced4da" id="jqvmap1_de"
                                class="jqvmap-region"></path>
                            <path
                                ...
                                stroke="#fff" stroke-width="3" stroke-linecap="round" stroke-linejoin="round"
                                stroke-opacity="0.3" fill="#ced4da" original="#ced4da" id="jqvmap1_dk"
                                class="jqvmap-region"></path>
                            <path
                                ...
                                stroke="#fff" stroke-width="3" stroke-linecap="round" stroke-linejoin="round"
                                stroke-opacity="0.3" fill="#ced4da" original="#ced4da" id="jqvmap1_ch"
                                class="jqvmap-region"></path>
                            <path
                                d="M488.43,184.87h2.97h1.46l2.37,1.69l4.39-3.65l-4.26-3.04l-4.22-2.04l-2.89,0.52l-3.92,2.52L488.43,184.87L488.43,184.87z"
                                stroke="#fff" stroke-width="3" stroke-linecap="round" stroke-linejoin="round"
                                stroke-opacity="0.3" fill="#ced4da" original="#ced4da" id="jqvmap1_cz"
                                class="jqvmap-region"></path>
                            <path
                                ...
                                stroke="#fff" stroke-width="3" stroke-linecap="round" stroke-linejoin="round"
                                stroke-opacity="0.3" fill="#ced4da" original="#ced4da" id="jqvmap1_sk"
                                class="jqvmap-region"></path>
                            <path
                                ...
                                stroke="#fff" stroke-width="3" stroke-linecap="round" stroke-linejoin="round"
                                stroke-opacity="0.3" fill="#ced4da" original="#ced4da" id="jqvmap1_at"
                                class="jqvmap-region"></path>
                            <path
                                ...
                                stroke="#fff" stroke-width="3" stroke-linecap="round" stroke-linejoin="round"
                                stroke-opacity="0.3" fill="#ced4da" original="#ced4da" id="jqvmap1_hu"
                                class="jqvmap-region"></path>
                            <path
                                d="M494.8,191.99l-2.54,1.52l-4.74,1.04l0.95,2.74l3.32,0.04l3.06-2.56L494.8,191.99L494.8,191.99z"
                                stroke="#fff" stroke-width="3" stroke-linecap="round" stroke-linejoin="round"
                                stroke-opacity="0.3" fill="#ced4da" original="#ced4da" id="jqvmap1_si"
                                class="jqvmap-region"></path>
                            <path
                            ...
                            <path
                                ...
                                stroke="#fff" stroke-width="3" stroke-linecap="round" stroke-linejoin="round"
                                stroke-opacity="0.3" fill="#ced4da" original="#ced4da" id="jqvmap1_ua"
                                class="jqvmap-region"></path>
                            <path
                                d="M520.75,187.71l3.1,4.77l-0.26,2.7l1.11,0.05l2.63-4.45l-3.16-3.92l-1.79-0.74L520.75,187.71L520.75,187.71z"
                                stroke="#fff" stroke-width="3" stroke-linecap="round" stroke-linejoin="round"
                                stroke-opacity="0.3" fill="#ced4da" original="#ced4da" id="jqvmap1_md"
                                class="jqvmap-region"></path>
                            <path
                                ...
                                stroke="#fff" stroke-width="3" stroke-linecap="round" stroke-linejoin="round"
                                stroke-opacity="0.3" fill="#ced4da" original="#ced4da" id="jqvmap1_ro"
                                class="jqvmap-region"></path>
                            <path
                                ...
                                stroke="#fff" stroke-width="3" stroke-linecap="round" stroke-linejoin="round"
                                stroke-opacity="0.3" fill="#ced4da" original="#ced4da" id="jqvmap1_rs"
                                class="jqvmap-region"></path>
                            <path
                            ...
                            <path
                                ...
                                stroke="#fff" stroke-width="3" stroke-linecap="round" stroke-linejoin="round"
                                stroke-opacity="0.3" fill="#ced4da" original="#ced4da" id="jqvmap1_gr"
                                class="jqvmap-region"></path>
                        </g>
                    </svg></div>
            </div>
