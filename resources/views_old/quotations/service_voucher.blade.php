                                            ...
                                            <tbody>
                                                @isset($get_land_services_details->adult_entries)
                                                    @foreach (json_decode($get_land_services_details->adult_entries) as $val)
                                                        {{-- {{dd($val)}} --}}
                                                        <tr>
                                                            <td>{{ get_land_issuance_details($get_hotel_details?->quotation_id)['transport'] }}
                                                            </td>
                                                ...
                                                @isset($get_ticket_details)
                                                    @foreach (json_decode($get_ticket_details->adult_entries) as $key => $val)
                                                        ...
                                                        @for ($i = 0; $i < $count_flight; $i++)
                                                            <tr>
                                                                <td>{{ ++$number }}</td>
                                                                <td>{{ get_flight_issuance_details($get_hotel_details->quotation_id)[$key]['flight_no'] }}
                                                                </td>
                                                                <td>{{ get_flight_issuance_details($get_hotel_details->quotation_id)[$key]['airline_arrival_date'] }}
                                                                </td>
                                                                <td>{{ get_flight_issuance_details($get_hotel_details->quotation_id)[$key]['arrival_time'] }}
                                                                </td>
                                                                <td>{{ get_flight_issuance_details($get_hotel_details->quotation_id)[$key]['departure_time'] }}
                                                                </td>
                                                                <td>{{ get_flight_issuance_details($get_hotel_details->quotation_id)[$key]['airline_flight_class'] }}
                                                                </td>
