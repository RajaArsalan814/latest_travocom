...
@section('content')
    ...
    <h2 class="az-content-title" style="display: inline">Add New Inquiry <span><a href="{{ url('inquiry') }}"
                    ...
                    <div id="wizard2" class="col-md-12">
                        ...
                        <section>
                            <div class="row row-lg">
                                ...
                                <div class="col-lg-2" id="customer_details" style="border-left:1px solid #e3e7ed;">
                                    ...
                                    <p class="az-content-label tx-11 tx-medium tx-gray-600" style="font-size:12px;">Country:
                                        <span style="text-decoration: underline;"></span>
                                    </p>
                                    <p class="az-content-label tx-11 tx-medium tx-gray-600" style="font-size:12px;">Last
                                        Inquiry# <span style="text-decoration: underline;"></span></p>
                                    <p class="az-content-label tx-11 tx-medium tx-gray-600" style="font-size:12px;">Inquiry
                                        Status: <span style="text-decoration: underline;"></span></p>

                                </div>
                                <div class="col-lg-2">
                                    <img src="{{ asset('img/default_user_2.png') }}"
                            ...
                            <div class="row row-sm" id="customer_div">
                                <div class="col-lg-4 mg-t-20 mg-md-t-0">
                                    <div class="form-group">
                                        ...
                                        <input id="customer_name" class="form-control " data-parsley-id="7"
                                            name="customer_name" placeholder="Enter Full Name" type="text">
                                    </div><!-- col -->
                                ...
                                <div class="col-md-4 mg-t-20 mg-md-t-0">
                                    <div class="form-group">
                                        <label class="az-content-label tx-11 tx-medium tx-gray-600">WhatsApp <input
                                                type="checkbox" name="whatsapp_check"><span><br>Customer Cell</span> <span
                                                style="color:red;">*</span>
                                        </label>

                                        <input type="tel" id="customer_cell" style="width: 100% !important"
                                ...
                                <div class="row ">
                                    <div class="col-lg-4 mg-t-20 mg-lg-t-0 mt-2">
                                        <div class="form-group">
                                            ...
                                            <label class="az-content-label tx-11 tx-medium tx-gray-600">No Of Adults<span
                                                    style="color:red;">*</span></label>
                                            <input type="number" required class="form-control" name="no_of_adults">
                                        </div>
                                    </div>
                                    <div class="col-lg-4 mg-t-20 mg-lg-t-0 mt-2">
                                        <div class="form-group">
                                    ...
                                    <div class="col-lg-4 mg-t-20 mg-lg-t-0 mt-2">
                                        <div class="form-group">
                                            ...
                                            <label class="az-content-label tx-11 tx-medium tx-gray-600">No Of
                                                Infants</label>
                                            <input type="number" class="form-control" name="no_of_infants">
                                        </div>
                                    </div>
                                </div>
    ...
    @push('scripts')
        ...
        <script>
            ...
            function check_validation() {
                ...
                if (!$('#customer_name').is(":disabled") && $('#customer_name').val().length < 1) {
                    message1 = "<li style='text-align:left;' class='text-danger'>Customer Name is Empty</li>";
                    message += message1;
                    var count_errors = count_errors + 1
                }
                if (!$('#customer_cell').is(":disabled") && $('#customer_cell').val().length < 1) {
                    message2 = "<li style='text-align:left;' class='text-danger'>Customer Cell is Empty</li>";
                    message += message2;
                    var count_errors = count_errors + 1
                }
                if ($('#inquiry_type').val() == "Select Inquiry Type") {
                    message3 = "<li style='text-align:left;' class='text-danger'>Inquiry Type is Empty</li>";
                    var count_errors = count_errors + 1
                    message += message3;

                }
                if ($('#services').val() == "Select Services") {
                    message4 = "<li style='text-align:left;' class='text-danger'>Services is Empty</li>";
                    message += message4;
                ...
                if ($('input[name="travel_date"]').val().length < 1) {
                    message6 = "<li style='text-align:left;' class='text-danger' >Travel Date is Empty</li>";
                    message += message6;
                    var count_errors = count_errors + 1
                }
                if ($('#sale_person').val().length < 1) {
                    message7 = "<li style='text-align:left;' class='text-danger'>Sale Person is Empty</li>";
                    message += message7;
                    var count_errors = count_errors + 1
                }
                if ($('#remarks').val().length < 1) {
                    message8 = "<li style='text-align:left;' class='text-danger'>Remarks is Empty</li>";
                    message += message8;
                    var count_errors = count_errors + 1
                }
        ...
        <script>
            ...
            function clear_feilds() {
                ...
                var text4 =
                    '<p class="az-content-label tx-11 tx-medium tx-gray-600" style="font-size:12px;">Country: <span style="text-decoration: underline;"></span></p>';
                var text5 =
                ...
                var text6 =
                    '<p class="az-content-label tx-11 tx-medium tx-gray-600" style="font-size:12px;">Inquiry Status: <span style="text-decoration: underline;"></span></p>';
                $("#search_result").empty();
                $("#customer_details").empty().append(text1, text2, text3, text6, text4, text5);
