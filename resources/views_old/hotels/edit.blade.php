                ...
                <form method="POST" action="{{ url('hotels/update/' . \Crypt::encrypt($edit_hotel->id_hotels)) }}"
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <select class="form-control select2" name="hotel_type">
                                    ...
                                    <option <?= $edit_hotel->hotel_type == 'D-Tour' ? 'selected' : '' ?>  value="D-Tour">D-Tour</option>
                                    <option <?= $edit_hotel->hotel_type == 'I-Tour' ? 'selected' : '' ?> value="I-Tour">I-Tour</option>
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <select class="form-control select2" name="hotel_category">
                                    <option>Select Hotel Type</option>
                                    <option <?= $edit_hotel->hotel_category == 'Economy' ? 'selected' : '' ?> value="Economy">
                                        Economy</option>
                                    <option <?= $edit_hotel->hotel_category == 'Standard' ? 'selected' : '' ?> value="Standard">
                                        Standard</option>
                    ...
                    <div class="col-md-12">
                        <div class="form-group">
                            ...
                            <select name="country_city" id="country-dropdown" class="form-control livesearch">
                                <option value="{{ $edit_hotel->country }}">{{ $edit_hotel->country }}</option>{{-- @forelse ($countries as $con)
                    ...
                    <div class="form-group">
                        ...
                        <select class="form-control select2" name="hotel_status">
                            <option <?= $edit_hotel->hotel_status == 1 ? 'selected' : '' ?> value="1">Active</option>
                            <option <?= $edit_hotel->hotel_status == 0 ? 'selected' : '' ?> value="0">Deactive</option>
