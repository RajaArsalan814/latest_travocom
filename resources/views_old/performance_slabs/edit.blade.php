                                ...
                                <div class="col-md-12">
                                    <div class="form-group">
                                        ...
                                        <input type="text" readonly name="end_date"
                                            value="{{ $performance_slabs->end_date }}" class="form-control fc-datepicker">
                                    </div>
                                </div>
                                ...
                                <div class="col-md-12">
                                    <div class="form-group">
                                        ...
                                        <input type="number" min="0" name="slab_amount"
                                            value="{{ $performance_slabs->slab_amount }}" class="form-control">
                                    </div>
                                </div>
                                ...
                                <div class="col-md-12">
                                    <div class="form-group">
                                        ...
                                        <input type="number" min="0" name="month"
                                            value="{{ $performance_slabs->month }}" class="form-control">
                                    </div>
                                </div>
                                ...
                                <div class="col-md-12">
                                    <div class="form-group">
                                        ...
                                        <input type="number" min="0" value="{{ $performance_slabs->no_of_persons }}"
                                            name="no_of_persons" class="form-control">
                                    </div>
                                </div>
