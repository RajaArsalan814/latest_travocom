                    ...
                    <tbody>
                        ...
                        ?>
                            <tr>
                                ...
                                <td>{{ $key + 1 }}</td>
                                <td> <a
                                        href="{{ url('/inquiry?q=' . $type->inquiry_id) }}"><span class="badge badge-success" style="font-size:16px;">INQ#<b>{{ $type->inquiry_id }}</b></span> 
                                    </a></td>
                                    <td><span class="badge badge-success" style="font-size:16px;"><?=$type->customer_name?></span></td>
                                ...
                                <?php if ($type->assign_by == auth()->user()->id){?>
                                    <td> <span class="badge badge-success" style="font-size:16x;">MYSELF</span></td>
                                <?php }else{
