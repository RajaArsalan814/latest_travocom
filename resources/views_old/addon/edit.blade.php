...
@section('content')
    ...
    <h2 class="az-content-title" style="display: inline">Edit Addon <span><a
                href="{{ url('addons') }}" class="btn btn-az-primary" style="float: right">Addons List</a></span></h2>
                            ...
                            <div class="row row-sm mg-b-20">
                                <div class="col-md-12">
                                    <div class="form-group">
                                        ...
                                        <input type="text" value="{{ $edit->addon_name }}" name="addon_name" class="form-control" required />
                                    </div>
                                </div>
                            ...
                            <div class="row row-sm mg-b-20">
                                <div class="col-md-12">
                                    <div class="form-group">
                                        ...
                                        <input type="number" min="1" value="{{ $edit->addon_cost_price }}" name="cost_price" class="form-control"
                                            required />
                                    </div>
                                </div>
                            ...
                            <div class="row row-sm mg-b-20">
                                <div class="col-md-12">
                                    <div class="form-group">
                                        ...
                                        <input type="number" min="1" value="{{  $edit->addon_selling_price }}" name="sell_price" class="form-control"
                                            required />
                                    </div>
                                </div>
