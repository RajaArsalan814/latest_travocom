      ...
      <div class="container mn-ht-100p">
        <div class="az-content-left az-content-left-profile">
          ...
          <div class="az-profile-overview">
            <div class="az-img-user">
              <img src="../img/faces/face10.jpg" alt="">
            </div><!-- az-img-user -->
            <div class="d-flex justify-content-between mg-b-20">
              <div>
                <h5 class="az-profile-name">Admin</h5>
        ...
        <div class="az-content-body az-content-body-profile">
          <nav class="nav az-nav-line">
            <a href="" class="nav-link active" data-bs-toggle="tab">Overview</a>
            <a href="" class="nav-link" data-bs-toggle="tab">Reviews</a>
            <a href="" class="nav-link" data-bs-toggle="tab">Followers</a>
            <a href="" class="nav-link" data-bs-toggle="tab">Following</a>
            <a href="" class="nav-link" data-bs-toggle="tab">Account Settings</a>
          </nav>
