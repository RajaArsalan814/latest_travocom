                ...
                <table id="example2" class="table table-striped">
                    <thead>
                        <tr>
                            ...
                            <th>Department</th>
                            <th class="wd-20p">Create Quotation</th>
                    ...
                    <tbody>
                        ...
                        @foreach ($my_jobs as $key => $type)
                            ...
                            <tr>
                                ...
                                <td>{{ $key + 1 }}</td>
                                <td> <a
                                        href="{{ url('/inquiry?q=' . $type->inquiry_id) }}"><span class="badge badge-info" style="font-size:18px;">INQ#<b>{{ $type->inquiry_id }}</b></span> 
                                    </a></td>
                                    <td><?=$type->customer_name?></td>
                                    <td>-</td>
                                    <td><?=$type->type_name?></td>
                                <td>
                                    <a href="{{ url('create_quotation/' . \Crypt::encrypt($type->inquiry_id)) }}" style="color:#fff;"
                                        class="btn btn-rounded btn-success">Create Quotation</a>
                                </td>
                               
                                <?php if ($type->assign_by == auth()->user()->id){?>
                                    <td> <span class="badge badge-success" style="font-size:18px;">MYSELF</span></td>
                                <?php }else{
                                   
                                        $user_name = App\User::find($type->assign_by);
                                   ?>
                                    <td> <span class=" badge badge-info" style="font-size:18px;">{{ $user_name?->name }}</span></td>
                                <?php }?>
