...
@section('content')
    ...
    <h2 class="az-content-title" style="display: inline">Add New Land Services Type <span><a
                href="{{ url('land_services_types') }}" class="btn btn-az-primary" style="float: right">Land Services Types
            </a></span></h2>
                    ...
                    <div class="row">
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="row-sm mg-b-20">
                                    <div class="form-group">
                                        <label for="">Service Type <span style="font-size: 12px">( Press enter to
                                                select
                                                service type )</span> <span class="text-danger"><b>*</b></span></label>
                        ...
                        <br>
                        <button type="submit" class="btn btn-indigo" style="float: right">Create</button>
