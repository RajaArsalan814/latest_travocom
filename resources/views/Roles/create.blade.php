...
<h2 class="az-content-title" style="display: inline">Add New Role <span><a href="{{ url('roles') }}"
                                                                           class="btn btn-az-primary" style="float: right">Roles List</a></span></h2>
                ...
                <div class="row row-sm mg-b-20">
                    <div class="col-md-12">
                        ...
                        <div class="form-group">
                            <label class="az-content-label tx-11 tx-medium tx-gray-600">Role Name</label>
