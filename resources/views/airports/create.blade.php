...
@section('content')
    ...
    <h2 class="az-content-title" style="display: inline">Add Airport <span><a href="{{ url('airports') }}"
                class="btn btn-az-primary" style="float: right">Airport List</a></span></h2>
    ...
    <div class="row">
        <div class="col-md-12 col-lg-12 col-xl-12">
            <div class="card card-body pd-40">
                <h5 class="card-title mg-b-20">Add Airport Details</h5>
                <form method="post" enctype="multipart/form-data" action="{{ url('airports/store') }}">
                    @csrf
                    @if (count($errors) > 0)
                        <div class="p-1">
                    ...
                    <div class="row row-sm mg-b-20">
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <input type="text" name="airport_short_code" class="form-control" required />
                            </div>
                        </div>
                    </div>
                    <!-- form-group -->
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                <div class="form-group">
                                    ...
                                    <select class="form-control select2 livesearch_country " id="country-dropdown"
                                        name="airport_country" required>
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                <div class="form-group">
                                    ...
                                    <select class="form-control select2 livesearch_city" name="airport_city"
                                        id="city-dropdown" required>
