    ...
    <div class="row">
        <div class="col-md-12 col-lg-12 col-xl-12">
            <div class="card card-body pd-40">
                ...
                <form method="POST" action="{{ url('airports/update/' . \Crypt::encrypt($airports->id_airports)) }}"
                    ...
                    <div class="row row-sm mg-b-20">
                        <div class="col-md-8">
                            <div class="form-group">
                                ...
                                <input type="text" value="{{ $airports->name }}" name="airport_name" class="form-control"
                                    required />
                            </div>
                        </div>
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <input type="text" value="{{ $airports->code }}" name="airport_short_code"
                            ...
                            <div class="form-group">
                                <div class="form-group">
                                    ...
                                    <select class="form-control select2 livesearch_country " id="country-dropdown"
                                        ...
                                        <option value="{{ $airports->countryName }}">{{ $airports->countryName }}
                                        </option>
