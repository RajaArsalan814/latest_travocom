...
<div id="modaldemo7" class="modal fade bd-example-modal-lg " role="dialog" aria-labelledby="myLargeModalLabel"
    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header">
                <h6 class="modal-title">Add Payments</h6>
                <button type="button" class="close" data-bs-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">×</span>
                </button>
            </div>
            <div class="modal-body">
                ...
                <form method="POST" enctype="multipart/form-data" action="{{ url('pay_quotation_amount') }}">
                    ...
                    <!--                    <div class="form-group">
                                            ...
                                            <select class="form-control select2" style="width: 100%;" required multiple
                                                name="services_type[]" id="pay_services_append">
                                            </select>
                                        </div>-->
                    <div class="form-group">
                        <label for="">Total Receivable Amount</label>
                    ...
                    <div class="form-group">
                        ...
                        <select class="form-control" onchange="onchange_payment_type()" name="payment_type"
                            ...
                            <option value="Online_transfer">Bank Online Deposit</option>
                            <option value="Clearing">Clearing</option>
                        </select>
                    </div>
                    <div class="form-group" id="d_bank">
                        <label for="">Customer Bank Account<span style="color:red;">*</span></label>
                        <select class="form-control" name="bank_name" id="bank_name">
                            <option value="">Select</option>
                            <option value="Meezan Bank">Cash</option>
                    ...
                    <div class="form-group" id="my_bank">
                        <label for="">Travocom Bank Accounts <span style="color:red;">*</span></label>
                        <select class="form-control" name="my_bank" id="my_bank">
                            <option value="">Select</option>
                            <?php
                            $my_bank_accounts = get_my_banks();
                            ?>
                            
                            @if(!empty($my_bank_accounts))
                            @foreach($my_bank_accounts as $our_banks)
                            <option value="{{$our_banks->id_bank_accounts}}">{{$our_banks->bank_name}} - {{$our_banks->account_number}}</option>
                            @endforeach
                            @endif
                        </select>
                    </div>
                    
                    <div class="form-group" id="d_cheque_date">
                        <label for="">Cheque Date <span style="color:red;">*</span></label>
                        <input type="date" class="form-control" name="cheque_date" id="my_cheque_date">
                    </div>
                    <div class="form-group" id="d_deposit_date">
                        <label for="">Deposit Date <span style="color:red;">*</span></label>
                        <input type="date" class="form-control" name="deposit_date" id="my_cheque_date">
                    </div>
                    <div class="form-group" id="d_clearing_date">
                        <label for="">Clearing Date <span style="color:red;">*</span></label>
                        <input type="date" class="form-control" name="clearing_date" id="my_cheque_date">
                    </div>
                    <div class="form-group">
                        <label for="">Receiving Amount <span style="color:red;">*</span></label>
                        <input type="number" min="0" onchange="onchange_amount_val()" id="enter_amount" class="form-control"
                               name="enter_amount" required="required">
                    </div>
                    <div class="form-group">
                        <label for="">Remarks</label>
                        <input type="text" id="payment_remarks" class="form-control"
                               name="payment_remarks">
                    </div>

                    <div class="form-group">
                        <label for="" id="image_file_label">Attachment</label>
                        <input type="file" class="form-control" name="image_file" id="image_file">
                    </div>

            </div>
            <div class="modal-footer">
                <button id="pay_btn" type="submit" class="btn btn-indigo">Submit</button>
                </form>
                <button type="button" class="btn btn-outline-light" data-bs-dismiss="modal">Close</button>
            </div>
        </div>
...
<div id="modaldemo8" class="modal fade bd-example-modal-lg " role="dialog" aria-labelledby="myLargeModalLabel"
    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header">
                <h6 class="modal-title">PAYMENT DETAILS FOR <span style="color:green;" id="payment_number"></span>| STATUS: <span class="badge badge-warning" id="payment_status"></span></h6>
                <button type="button" class="close" data-bs-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">×</span>
                </button>
            </div>
            <div class="modal-body">
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="card bg-light rounded-10">
                            <div class="card-body">
                                <div class="col-lg-6">
                                    <b>PAYMENT TYPE:</b> <span id="ac_payment_type"></span>
                                </div>
                                <div class="col-lg-6" id="customer_bank">
                                    <b>CUSTOMER BANK:</b> <span id="ac_customer_bank"></span>
                                </div>
                                <div class="col-lg-6" id="our_bank">
                                    <b>TRAVOCOM BANK:</b> <span id="ac_our_bank"></span>
                                </div>
                                <div class="col-lg-6" id="cheque_date">
                                    <b>CHEQUE DATE:</b> <span id="ac_cheque_date"></span>
                                </div>
                                <div class="col-lg-6" id="deposit_date">
                                    <b>DEPOSIT DATE:</b> <span id="ac_deposit_date"></span>
                                </div>
                                <div class="col-lg-6" id="clearing_date">
                                    <b>CLEARING DATE:</b> <span id="ac_clearing_date"></span>
                                </div>
                                <div class="col-lg-6">
                                    <b>RECEIVED AMOUNT:</b> <span id="ac_amount"></span>
                                </div>
                                <div class="col-lg-12">
                                    <b>REMARKS:</b> <span id="ac_payment_remarks"></span>
                                </div>
                                <div class="col-lg-12">
                                    <b>PAYMENT VERIFICATION:</b> <span id="ac_payment_verification"></span>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <form method="POST" action="{{ url('update_receiving_number') }}">
                    ...
                    <div class="form-group" id="d_attachment">
...
<div id="modaldemo9" class="modal fade bd-example-modal-lg " role="dialog" aria-labelledby="myLargeModalLabel"
     aria-hidden="true">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header">
                <h6 class="modal-title">ACCOUNTS PAYMENT DETAILS FOR <span style="color:green;" id="ac1_payment_number"></span>| STATUS: <span class="badge badge-warning" id="ac1_payment_status"></span></h6>
                <button type="button" class="close" data-bs-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">×</span>
                </button>
            </div>
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="card bg-light rounded-10">
                            <div class="card-body">
                                <div class="col-lg-6">
                                    <b>PAYMENT TYPE:</b> <span id="ac1_payment_type"></span>
                                </div>
                                <div class="col-lg-6" id="ac2_customer_bank">
                                    <b>CUSTOMER BANK:</b> <span id="ac1_customer_bank"></span>
                                </div>
                                <div class="col-lg-6" id="ac2_our_bank">
                                    <b>TRAVOCOM BANK:</b> <span id="ac1_our_bank"></span>
                                </div>
                                <div class="col-lg-6" id="ac2_cheque_date">
                                    <b>CHEQUE DATE:</b> <span id="ac1_cheque_date"></span>
                                </div>
                                <div class="col-lg-6" id="ac2_deposit_date">
                                    <b>DEPOSIT DATE:</b> <span id="ac1_deposit_date"></span>
                                </div>
                                <div class="col-lg-6" id="ac2_clearing_date">
                                    <b>CLEARING DATE:</b> <span id="ac1_clearing_date"></span>
                                </div>
                                <div class="col-lg-6">
                                    <b>RECEIVED AMOUNT:</b> <span id="ac1_amount"></span>
                                </div>
                                <div class="col-lg-12">
                                    <b>REMARKS:</b> <span id="ac1_payment_remarks"></span>
                                </div>
                                <div class="col-lg-12">
                                    <b>PAYMENT VERIFICATION:</b> <span id="ac1_payment_verification"></span>
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <form method="POST" action="{{ url('update_receiving_number') }}">
                ...
                @csrf
                <input type="hidden" name="quote_pay_id" id="ac1_payment_id"/>
                    <div class="col-lg-12">
                        <div class="card bg-light rounded-10">
                            <div class="card-body">
                                <div class="form-group">
                                    <label class="mt-2">RV-Number</label>
                                    <input type="number" class="form-control" name="accounts_rv_number" id="accounts_rv_number"/>
                                </div>
                                <div class="form-group">
                                    <label class="mt-2" id="ac_number_label">Account Number</label>
                                    <input type="number" class="form-control" name="accounts_ac_number" id="accounts_ac_number"/>
                                </div>
                                <div class="form-group">
                                    <label class="mt-2" id="ac_cheque_label">Cheque Number</label>
                                    <input type="number" class="form-control" name="accounts_cheque_number" id="accounts_cheque_number"/>
                                </div>
                                <br>
                                <div class="col-lg-3">
                                    <label class="ckbox">
                                        <input type="checkbox" name="accounts_payment_verification" id="accounts_payment_verification"><span>Payment Verification</span>
                                    </label>
                                </div>
                            </div>
                        </div>
                ...
                {{-- <label for="">Assign Services And Sub Services</label> --}}
                    ...
                    <br>
                    <div class="form-group" id="ac2_attachment">
                        <label for="" style="text-align: center">Attachment</label>
                        <img id="ac2_image_url" style="height:250px;" src="" class="without-caption image-link" style="width: 100%;height: 200px"
                             alt="">
                    </div>
...
<script>
                            ...
                            function onchange_payment_type() {
                                ...
                                if (p_type == "Cash") {
                                    ...
                                    $('#my_cheque_date').css('display', 'none');
                                    $('#d_cheque_date').css('display', 'none');
                                    $('#d_deposit_date').css('display', 'none');
                                    $('#my_bank').css('display', 'none');
                                    $('#d_clearing_date').css('display', 'none');

                                }
                                else if (p_type == "Cheque") {
                                    $('#d_cheque_no').css('display', 'none');
                                    $('#cheque_date').css('display', 'block');
                                    $('#d_cheque_date').css('display', 'block');
                                    $('#d_bank').css('display', 'block');
                                    $('#d_account_number').css('display', 'none');
                                    $('#image_file').css('display', 'block');
                                    $('#image_file_label').css('display', 'block');
                                    ...
                                    $('#image_file_label').css('display', 'block');
                                    $('#customer_bank').css('display', 'block');
                                    $('#d_deposit_date').css('display', 'block');
                                    $('#d_clearing_date').css('display', 'none');
                                    ...
                                    $('#customer_bank').css('display', 'block');
                                    $('#d_deposit_date').css('display', 'block');
                                    $('#d_clearing_date').css('display', 'block');
                                    $('#my_bank').css('display', 'block');
