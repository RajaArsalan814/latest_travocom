                    ...
                    <div class="card-body">
                        <div class="invoice-title">
                            <h4 class="float-end font-size-15">{{ $get_quotation->quotation_no }}
                                <span class="badge bg-primary font-size-12 ms-2">No Of Person</span>
                        ...
                        <div class="py-2">
                                ...
                                <table class="table align-middle table-nowrap table-centered mb-0">
                                    <thead>
                                        <tr>
                                            ...
                                            <th class="text-center">Total In PKR</th>
                                        </tr>
                                    </thead><!-- end thead -->
                                    <tbody>
                                                                ...
                                                                <tbody>
                                                                    ...
                                                                    @for ($i; $i < $get_size_hotel_name; $i++)
                                                                        <tr>
                                                                            ...
                                                                            <td>{{ $hotel_json_decode_all_entries[$i]->hotel_addon }}
                                                                            </td>
                                                                            <td>{{ $hotel_json_decode_person_pricing_details[$i]->hotel_qty }}
                                                                            </td>
                                                                            <td>{{ $hotel_json_decode_person_pricing_details[$i]->hotel_no_of_beds }}
                                                                            </td>
                            ...
                            @if ($q_details->services_type == 'Visa')
                                ...
                                <td class="text-center">
                                    {{ $decode_sub_total_details[0]->visa_total }} |
                                    {{ $q_details->default_rate_of_exchange }}</td>

                                <td class="text-center">
                                    {{ ($decode_sub_total_details[0]->visa_total * $q_details->default_rate_of_exchange_amt) / 1 }}
                                </td>
                            @elseif ($q_details->services_type == 'Air Ticket')
                                <td class="text-center">
                                ...
                                <td class="text-center">
                                    {{ $decode_sub_total_details[0]->airline_total }} |
                                    {{ $q_details->default_rate_of_exchange }}</td>
                                </td>
                                <td class="text-center">
                                    {{ ($decode_sub_total_details[0]->airline_total * $q_details->default_rate_of_exchange_amt) / 1 }}
                                </td>
                            @elseif($q_details->services_type == 'Land Services')
                                <td class="text-center">
                                ...
                                <td class="text-center">
                                    {{ $decode_sub_total_details[0]->land_services_total }} |
                                    {{ $q_details->default_rate_of_exchange }}</td>
                                </td>
                                <td class="text-center">
                                    {{ ($decode_sub_total_details[0]->land_services_total * $q_details->default_rate_of_exchange_amt) / 1 }}
                                </td>
                            @elseif($q_details->services_type == 'Hotel')
                                <td class="text-center">
                                ...
                                <td class="text-center">
                                    {{ $decode_sub_total_details[0]->hotel_total }} |
                                    {{ $q_details->default_rate_of_exchange }}</td>

                                </td>
                                <td class="text-center">
                                    {{ ($decode_sub_total_details[0]->hotel_total * $q_details->default_rate_of_exchange_amt) / 1 }}
                            ...
                            <hr>
                            <tr>
                                <th scope="row" colspan="6" class="border-1 text-end">
                            ...
                            <tr>
                                <th scope="row" colspan="6" class="border-1 text-end">Total</th>
                                <td class="border-1 text-end">
