...
@section('content')
    ...
    <h2 class="az-content-title" style="display: inline">Add New Visa Rates <span><a href="{{ url('visa_rate') }}"
                  ...
                  <div class="row">
                        ...
                        <div class="row row-sm mg-b-20">
                            <div class="col-md-11">
                                <div class="form-group">
                                    ...
                                    <input class="form-control" type="text" name="adult_cost_price" required />
                                </div>
                            </div>
                    ...
                    <div class="col-md-6" >
                        <div class="row row-sm mg-b-20">
                            <div class="col-md-11">
                                <div class="form-group">
                                    <label class="az-content-label tx-11 tx-medium tx-gray-600">Adult Selling Price <span class="text-danger"><b>*</b></span></label>
                                    <input class="form-control" type="text" name="adult_selling_price" required/>
                                </div>
                            </div>
                        ...
                        <div class="row row-sm mg-b-20">
                            <div class="col-md-11">
                                <div class="form-group">
                                    ...
                                    <input class="form-control" type="text" name="child_cost_price" required/>
                                </div>
                            </div>
                    ...
                    <div class="col-md-6 " >
                        <div class="row row-sm mg-b-20">
                            <div class="col-md-11">
                                <div class="form-group">
                                    <label class="az-content-label tx-11 tx-medium tx-gray-600">Child Selling Price <span class="text-danger"><b>*</b></span></label>
                                    <input class="form-control" type="text" name="child_selling_price" required/>
                                </div>
                            </div>
                    ...
                    <div class="col-md-6 " >
                        <div class="row row-sm mg-b-20">
                            <div class="col-md-11">
                                <div class="form-group">
                                    <label class="az-content-label tx-11 tx-medium tx-gray-600">Infant Cost Price <span class="text-danger"><b>*</b></span></label>
                                    <input class="form-control" type="text" name="infant_cost_price" required/>
                                </div>
                            </div>
                    ...
                    <div class="col-md-6 " >
                        <div class="row row-sm mg-b-20">
                            <div class="col-md-11">
                                <div class="form-group">
                                    <label class="az-content-label tx-11 tx-medium tx-gray-600">Infant Selling Price <span class="text-danger"><b>*</b></span></label>
                                    <input class="form-control" type="text" name="infant_selling_price" required/>
                                </div>
                            </div>
