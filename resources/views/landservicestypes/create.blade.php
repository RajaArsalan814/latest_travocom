...
@section('content')
    ...
    <h2 class="az-content-title" style="display: inline">Add New Land Services<span><a href="{{ url('land_services') }}"
    ...
    <div class="row">
        <div class="col-md-12 col-lg-12 col-xl-12">
            <div class="card card-body pd-40">
                <h4 class="card-title mg-b-20">Add Land Services</h4>
                        ...
                        <div class="col-md-6 mt-2 ">
                            <div class="form-group">
                                ...
                                <select style="width: 100%" id="select_transport" class="js-example-basic-single"
                                        name="transport" required="required">
                                    <option value="">Select</option>
