...
//        dd($inquiry_details);
        echo '<input type="hidden" value="' . $data->id_customers . '" name="searched_customer_id"/>
            <p class="az-content-label tx-11 tx-medium tx-gray-600" style="font-size:12px;">Customer: <badge class="badge badge-rounded badge-info"><span style="font-size:12px;">' . $data->customer_name . '</span></badge></p>
            <p class="az-content-label tx-11 tx-medium tx-gray-600" style="font-size:12px;">Contact# <badge class="badge badge-rounded badge-warning"><span style="font-size:12px;">' . $data->customer_cell . '</span></badge></p>
                                <p class="az-content-label tx-11 tx-medium tx-gray-600" style="font-size:12px;">Email: <badge class="badge badge-rounded badge-warning"><span style="font-size:12px;">' . $data->customer_email . '</span></badge></p>'
                . '<p class="az-content-label tx-11 tx-medium tx-gray-600" style="font-size:12px;">Last Inquiry: <badge class="badge badge-rounded badge-warning"><span style="font-size:12px;">#'.$inquiry_details->id_inquiry.'</span></badge></p>'
                . '<p class="az-content-label tx-11 tx-medium tx-gray-600" style="font-size:12px;">Status: <badge class="badge badge-rounded badge-warning"><span style="font-size:12px;">'.$inquiry_details->status.'</span></badge></p>';
    }
